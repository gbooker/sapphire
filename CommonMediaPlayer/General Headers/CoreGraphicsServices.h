 ...
 * CommonMediaPlayer
 *
 * Created by Nicholas Gerakines on Apr 28 2006
 * Copyright 2006 nito
 * All rights reserved.
 *
...
extern CGContextRef CGWindowContextCreate( CGSConnection connection, CGSWindow window, void * someArg );
extern void CGContextCopyWindowCaptureContentsToRect(void *grafport, CGRect rect, int cid, int wid, int something);
extern void CGContextClear(CGContextRef c);
...
extern void CGSSetWindowOpacity(CGSConnection cid, CGSWindow wid, int opacity /* kCGSFalse, is that a CGSValue or standard char? */);
