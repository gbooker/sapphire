...
/*
    ...
    return ( self );
*/
	return ( [self initWithScene: scene directory:[NSHomeDirectory() stringByAppendingPathComponent:@"Movies"]] );
	[[NSFileManager defaultManager] subpathsAtPath:[NSHomeDirectory() stringByAppendingPathComponent:@"Movies"]];
}
...
- (void) itemSelected: (long) row
{
	...
	if([self isDirectory:[_dir stringByAppendingPathComponent:name]])
	{
		id controller = [[SapphireApplianceController alloc] initWithScene:[self scene] directory:[_dir stringByAppendingPathComponent:name]];
