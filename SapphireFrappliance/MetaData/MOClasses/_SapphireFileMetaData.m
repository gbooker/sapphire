...
// Make changes to SapphireFileMetaData.m instead.

#import "_SapphireFileMetaData.h"

@implementation _SapphireFileMetaData
...
- (NSNumber*)sampleRate {
	[self willAccessValueForKey:@"sampleRate"];
	NSNumber *result = [self primitiveValueForKey:@"sampleRate"];
	[self didAccessValueForKey:@"sampleRate"];
	return result;
}

- (void)setSampleRate:(NSNumber*)value_ {
	[self willChangeValueForKey:@"sampleRate"];
	[self setPrimitiveValue:value_ forKey:@"sampleRate"];
...
- (double)sampleRateValue {
	NSNumber *result = [self sampleRate];
	return result ? [result doubleValue] : 0;
}

- (void)setSampleRateValue:(double)value_ {
	[self setSampleRate:[NSNumber numberWithDouble:value_]];
}
...
- (NSNumber*)size {
	...
	NSNumber *result = [self primitiveValueForKey:@"size"];
...
- (void)setSize:(NSNumber*)value_ {
	...
	[self setPrimitiveValue:value_ forKey:@"size"];
...
- (NSNumber*)importType {
	[self willAccessValueForKey:@"importType"];
	NSNumber *result = [self primitiveValueForKey:@"importType"];
	[self didAccessValueForKey:@"importType"];
	return result;
}

- (void)setImportType:(NSNumber*)value_ {
	[self willChangeValueForKey:@"importType"];
	[self setPrimitiveValue:value_ forKey:@"importType"];
	[self didChangeValueForKey:@"importType"];
}



- (int)importTypeValue {
	NSNumber *result = [self importType];
	return result ? [result intValue] : 0;
}

- (void)setImportTypeValue:(int)value_ {
	[self setImportType:[NSNumber numberWithInt:value_]];
}
...
- (NSNumber*)fileContainerType {
	[self willAccessValueForKey:@"fileContainerType"];
	NSNumber *result = [self primitiveValueForKey:@"fileContainerType"];
	[self didAccessValueForKey:@"fileContainerType"];
	return result;
}

- (void)setFileContainerType:(NSNumber*)value_ {
	[self willChangeValueForKey:@"fileContainerType"];
	[self setPrimitiveValue:value_ forKey:@"fileContainerType"];
	[self didChangeValueForKey:@"fileContainerType"];
}



- (short)fileContainerTypeValue {
	NSNumber *result = [self fileContainerType];
	return result ? [result shortValue] : 0;
}

- (void)setFileContainerTypeValue:(short)value_ {
	[self setFileContainerType:[NSNumber numberWithShort:value_]];
}
...
- (SapphireEpisode*)tvEpisode {
	...
	[self didAccessValueForKey:@"tvEpisode"];
	return result;
}
