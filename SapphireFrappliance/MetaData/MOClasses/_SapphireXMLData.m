...
// Make changes to SapphireXMLData.m instead.

#import "_SapphireXMLData.h"

@implementation _SapphireXMLData
...
- (NSNumber*)lastEpisodeNumber {
	...
	[self didAccessValueForKey:@"lastEpisodeNumber"];
	return result;
}

- (void)setLastEpisodeNumber:(NSNumber*)value_ {
	[self willChangeValueForKey:@"lastEpisodeNumber"];
	[self setPrimitiveValue:value_ forKey:@"lastEpisodeNumber"];
	[self didChangeValueForKey:@"lastEpisodeNumber"];
}



- (short)lastEpisodeNumberValue {
	NSNumber *result = [self lastEpisodeNumber];
	return result ? [result shortValue] : 0;
}

- (void)setLastEpisodeNumberValue:(short)value_ {
	[self setLastEpisodeNumber:[NSNumber numberWithShort:value_]];
}
...
- (NSNumber*)searchLastEpisodeNumber {
	[self willAccessValueForKey:@"searchLastEpisodeNumber"];
	NSNumber *result = [self primitiveValueForKey:@"searchLastEpisodeNumber"];
	[self didAccessValueForKey:@"searchLastEpisodeNumber"];
	return result;
}

- (void)setSearchLastEpisodeNumber:(NSNumber*)value_ {
	[self willChangeValueForKey:@"searchLastEpisodeNumber"];
	[self setPrimitiveValue:value_ forKey:@"searchLastEpisodeNumber"];
	[self didChangeValueForKey:@"searchLastEpisodeNumber"];
}



- (short)searchLastEpisodeNumberValue {
	NSNumber *result = [self searchLastEpisodeNumber];
	return result ? [result shortValue] : 0;
}

- (void)setSearchLastEpisodeNumberValue:(short)value_ {
	[self setSearchLastEpisodeNumber:[NSNumber numberWithShort:value_]];
}
