...
// Make changes to SapphireMovie.m instead.

#import "_SapphireMovie.h"

@implementation _SapphireMovie
...
- (NSNumber*)rottonTomatoesCertifiedFresh {
	[self willAccessValueForKey:@"rottonTomatoesCertifiedFresh"];
	NSNumber *result = [self primitiveValueForKey:@"rottonTomatoesCertifiedFresh"];
	[self didAccessValueForKey:@"rottonTomatoesCertifiedFresh"];
	return result;
}

- (void)setRottonTomatoesCertifiedFresh:(NSNumber*)value_ {
	[self willChangeValueForKey:@"rottonTomatoesCertifiedFresh"];
	[self setPrimitiveValue:value_ forKey:@"rottonTomatoesCertifiedFresh"];
	[self didChangeValueForKey:@"rottonTomatoesCertifiedFresh"];
}



- (BOOL)rottonTomatoesCertifiedFreshValue {
	NSNumber *result = [self rottonTomatoesCertifiedFresh];
	return result ? [result boolValue] : 0;
}

- (void)setRottonTomatoesCertifiedFreshValue:(BOOL)value_ {
	[self setRottonTomatoesCertifiedFresh:[NSNumber numberWithBool:value_]];
}
...
- (NSData*)orderedGenresData {
	...
	[self didAccessValueForKey:@"orderedGenresData"];
	return result;
}
...
- (NSData*)overriddenDirectorsData {
	[self willAccessValueForKey:@"overriddenDirectorsData"];
	NSData *result = [self primitiveValueForKey:@"overriddenDirectorsData"];
	[self didAccessValueForKey:@"overriddenDirectorsData"];
	return result;
}

- (void)setOverriddenDirectorsData:(NSData*)value_ {
	[self willChangeValueForKey:@"overriddenDirectorsData"];
	[self setPrimitiveValue:value_ forKey:@"overriddenDirectorsData"];
	[self didChangeValueForKey:@"overriddenDirectorsData"];
}
...
- (NSData*)overriddenCastData {
	...
	[self didAccessValueForKey:@"overriddenCastData"];
	return result;
}
...
- (NSNumber*)imdbRating {
	[self willAccessValueForKey:@"imdbRating"];
	NSNumber *result = [self primitiveValueForKey:@"imdbRating"];
	[self didAccessValueForKey:@"imdbRating"];
	return result;
}

- (void)setImdbRating:(NSNumber*)value_ {
	[self willChangeValueForKey:@"imdbRating"];
	[self setPrimitiveValue:value_ forKey:@"imdbRating"];
	[self didChangeValueForKey:@"imdbRating"];
}



- (float)imdbRatingValue {
	NSNumber *result = [self imdbRating];
	return result ? [result floatValue] : 0;
}

- (void)setImdbRatingValue:(float)value_ {
	[self setImdbRating:[NSNumber numberWithFloat:value_]];
}
...
- (void)addDirectors:(NSSet*)value_ {
	[self willChangeValueForKey:@"directors" withSetMutation:NSKeyValueUnionSetMutation usingObjects:value_];
	[[self primitiveValueForKey:@"directors"] unionSet:value_];
	[self didChangeValueForKey:@"directors" withSetMutation:NSKeyValueUnionSetMutation usingObjects:value_];
}

-(void)removeDirectors:(NSSet*)value_ {
	[self willChangeValueForKey:@"directors" withSetMutation:NSKeyValueMinusSetMutation usingObjects:value_];
	[[self primitiveValueForKey:@"directors"] minusSet:value_];
	[self didChangeValueForKey:@"directors" withSetMutation:NSKeyValueMinusSetMutation usingObjects:value_];
}
...
- (void)addDirectorsObject:(SapphireDirector*)value_ {
	...
	[[self primitiveValueForKey:@"directors"] addObject:value_];
...
- (void)removeDirectorsObject:(SapphireDirector*)value_ {
	...
	[[self primitiveValueForKey:@"directors"] removeObject:value_];
...
- (NSMutableSet*)directorsSet {
	return [self mutableSetValueForKey:@"directors"];
}
...
- (void)addCast:(NSSet*)value_ {
	[self willChangeValueForKey:@"cast" withSetMutation:NSKeyValueUnionSetMutation usingObjects:value_];
	[[self primitiveValueForKey:@"cast"] unionSet:value_];
	[self didChangeValueForKey:@"cast" withSetMutation:NSKeyValueUnionSetMutation usingObjects:value_];
}

-(void)removeCast:(NSSet*)value_ {
	[self willChangeValueForKey:@"cast" withSetMutation:NSKeyValueMinusSetMutation usingObjects:value_];
	[[self primitiveValueForKey:@"cast"] minusSet:value_];
	[self didChangeValueForKey:@"cast" withSetMutation:NSKeyValueMinusSetMutation usingObjects:value_];
}
	
- (void)addCastObject:(SapphireCast*)value_ {
	NSSet *changedObjects = [[NSSet alloc] initWithObjects:&value_ count:1];
	[self willChangeValueForKey:@"cast" withSetMutation:NSKeyValueUnionSetMutation usingObjects:changedObjects];
	[[self primitiveValueForKey:@"cast"] addObject:value_];
	[self didChangeValueForKey:@"cast" withSetMutation:NSKeyValueUnionSetMutation usingObjects:changedObjects];
	[changedObjects release];
}

- (void)removeCastObject:(SapphireCast*)value_ {
	NSSet *changedObjects = [[NSSet alloc] initWithObjects:&value_ count:1];
	[self willChangeValueForKey:@"cast" withSetMutation:NSKeyValueMinusSetMutation usingObjects:changedObjects];
	[[self primitiveValueForKey:@"cast"] removeObject:value_];
	[self didChangeValueForKey:@"cast" withSetMutation:NSKeyValueMinusSetMutation usingObjects:changedObjects];
	[changedObjects release];
}

- (NSMutableSet*)castSet {
	return [self mutableSetValueForKey:@"cast"];
}
