...
#import <CommonMediaPlayer/CMPPlayerController.h>

@class SapphireFileMetaData;

@protocol CMPPlayerController;

@interface SapphireCMPWrapper : NSObject <CMPPlayerControllerDelegate>{
	SapphireFileMetaData		*file;
	id <CMPPlayerController>	controller;
}
